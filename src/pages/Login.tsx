...
import { initiateSpotifyAuth } from "@/spotify/spotify";
...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      {/* <div className="mt-8 text-sm text-transparent bg-clip-text bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 antialiased">
        <p>A vinyl experience for your digital music</p>
      </div> */}
      ...
      <div className="mt-8 relative">
        <style jsx>{`
          ...
          .animated-gradient {
            ...
            background-image: linear-gradient(90deg, #9ca3af, #6b7280, #4b5563);
            background-size: 200% 100%;
            animation: gradient 3s ease infinite;
          }
        `}</style>
        <p className="text-sm animated-gradient font-sans antialiased">
          A vinyl experience for your digital music
        </p>
      </div>
    </div>
  );
